      ...
      <div className="aboutus-content">
        <div className="aboutus-hero">
          <div className="hero-text-content">
            <h1>About SummitFlow</h1>
            <p className="hero-subtitle">Streamlining Your Meeting Room Experience</p>
          </div>
        </div>
        ...
        <section className="aboutus-section features-section">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p>Track your upcoming and past bookings all in one place with our organized dashboard.</p>
            </div>
          </div>
        </section>
